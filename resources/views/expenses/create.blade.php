<x-layouts.dashboard>
    <x-slot name="header">Tambah Pengeluaran</x-slot>
    ...
    <div class="max-w-2xl">
        <form action="{{ route('expenses.store') }}" method="POST"
            ...
            <div class="flex items-center gap-4 pt-4">
                <button type="submit"
                    class="px-6 py-3 bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 rounded-xl font-medium transition-all shadow-lg shadow-red-500/25">Simpan</button>
