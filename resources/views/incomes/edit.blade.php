<x-layouts.dashboard>
    <x-slot name="header">Edit Pemasukan</x-slot>
        ...
        <form action="{{ route('incomes.update', $income) }}" method="POST"
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3"
                    class="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500/50 focus:border-green-500 transition resize-none">{{ old('notes', $income->notes) }}</textarea>
